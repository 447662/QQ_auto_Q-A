...
7. **Link renderer**: Markdown links like `[京东自营商品页](https://item.jd.com/123.html)` and short links like `[京东短链](https://u.jd.com/xxx)` become clickable PDF hyperlinks, including links inside table cells.
...
| `--watermark` | `""` | Watermark text (empty = none); renders once per page at the center, not tiled |
